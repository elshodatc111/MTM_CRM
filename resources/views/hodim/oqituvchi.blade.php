...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">O'qituvchilar</h1>
        </div>
        @if (session('success'))
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">O'qituvchilar Jadvali</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Yangi O'qituvchi Qo‘shish</h5>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('hodim_create') }}">
                        ...
                        <div class="form-group">
                            <label for="email">O'qituvchi haqida</label>
