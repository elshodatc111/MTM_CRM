...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Oshpazlar</h1>
        </div>
        @if (session('success'))
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Oshpazlar</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Oshpazlar Jadvali</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Yangi Oshpaz Qo‘shish</h5>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('hodim_create') }}">
                        @csrf
                        <input type="hidden" name="type" value="oshpaz">
                        ...
                        <div class="form-group">
                            <label for="email">Oshpaz haqida</label>
