...
@section('title', 'Tarbiyachialar')

@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tarbiyachialar</h1>
        </div>
        @if (session('success'))
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Tarbiyachilar</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Tarbiyachialar Jadvali</h6>
                        ...
                        <tbody>
                            @foreach ($User as $meneger)
                                <tr>
                                    ...
                                    <td>
                                        @if($meneger->type == 'tarbiyachi')
                                            <span class="badge badge-primary">Katta tarbiyachi</span>
                                        @else 
                                            <span class="badge badge-warning">Yordamchi tarbiyachi</span>
                                        @endif
                                    </td>
                                    <td>{{ $meneger->email }}</td>
                                    <td>{{ $meneger->phone }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Yangi Tarbiyachi Qo‘shish</h5>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('hodim_create') }}">
                        ...
                        <div class="form-group">
                            <label for="email">Tarbiyachi haqida</label>
